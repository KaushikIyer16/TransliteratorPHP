...
chrome.runtime.onMessage.addListener(function(message, sender, sendResponse) 
{
	if(message == "tamMajority")
	{
		...
		chrome.contextMenus.update("B", {"enabled":true});
		chrome.contextMenus.update("B", {"title": "To Bengali"});
	}
	...
	else if(message == "benMajority")
	{
		...
		chrome.contextMenus.update("B", {"enabled":false});		
		chrome.contextMenus.update("B", {"title": "Page already in Bengali"});
	}
