...
chrome.runtime.onInstalled.addListener(function()
{
	...
	{
		"title" : "Transliterate to Gujarati",
		"contexts": ["page"],
		"id": "G"
	});
});
...
chrome.runtime.onMessage.addListener(function(message, sender, sendResponse) 
{
	if(message == "tamMajority")
	{
		...
		chrome.contextMenus.update("G", {"enabled":true});
		chrome.contextMenus.update("G", {"title": "To Gujarati"});
	}
	...
	else if(message == "gujMajority")
	{
		...
		chrome.contextMenus.update("G", {"enabled":false});	
		chrome.contextMenus.update("G", {"title": "Page already in Gujarati"});	
	}
