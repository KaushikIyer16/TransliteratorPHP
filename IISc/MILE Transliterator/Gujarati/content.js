...
function transliterate(text) // Transliteration function
{
    ...
    else if((from == "T") && (to == "G"))
    {
        ...
        return kanToGuj(pronunciation(ToKannada(x)));
    }
    else if((from == "B") && (to == "G"))
    {
    	return benToGuj(text);
    }
    else if((from == "P") && (to == "G"))
    {
    	return punToGuj(text);
    }
    else if((from == "K") && (to == "G"))
    {
    	return kanToGuj(text);
    }
    else if((from == "M") && (to == "G"))
    {
    	return malToGuj(text);
    }
    else if((from == "TEL") && (to == "G"))
    {
    	return telToGuj(text);
    }
    else if((from == "O") && (to == "G"))
    {
    	return oriToGuj(text);
    }
    else
    {
    	// alert("Not supported");
...
function oriToGuj(text)
{
	...
	for(var i = 0; i < text.length; i++)
	{
		...
		else
		{
			...
			if((unicode == 0x0B5C) || (unicode == 0x0B5D))
			{
				answer += String.fromCharCode(0x0AB0);
			}
			else if((unicode == 0x0B5F))
			{
				answer += String.fromCharCode(0x0AAF);
			}
			else if((unicode == 0x0B56) || (unicode == 0x0B57) || ((unicode >= 0x0B70) && (unicode <= 0x0B7F)))
			{
				answer += "";
			}
			else
...
function telToGuj(text)
{
	...
	for(var i = 0; i < text.length; i++)
	{
		...
		else
		{
			...
			if((unicode == 0x0C00))
			{
				answer += String.fromCharCode(0x0A81);
			}
			else if((unicode == 0x0C0E))
			{
				answer += String.fromCharCode(0x0A8F);
			}
			else if(unicode == 0x0C12)
			{
				answer += String.fromCharCode(0x0A93);
			}
			...
			{
				answer += String.fromCharCode(0x0AB3);
			}
			else if(unicode == 0x0C46)
			{
				answer += String.fromCharCode(0x0AC7);
			}
			else if(unicode == 0x0C4A)
			{
				answer += String.fromCharCode(0x0ACB);
			}
			else if(unicode == 0x0C58)
			{
				answer += String.fromCharCode(0x0AB8);
			}
			else if(unicode == 0x0C59)
			{
				answer += String.fromCharCode(0x0A9C) +String.fromCharCode(0x0ABC);
			}
...
function malToGuj(text)
{
	...
	for(var i = 0; i < text.length; i++)
	{
		...
		else
		{
			...
			{
				answer += String.fromCharCode(0x0AA8);
			}
			...
			{
				answer += String.fromCharCode(0x0D20);
			}
...
function kanToGuj(text)
{
	...
	for(var i = 0; i < text.length; i++)
	{
		...
		else
		{
			...
			else if((unicode == 0x0CD5) || (unicode == 0x0CD6) || (unicode == 0x0CDE) || ((unicode >= 0x0CF0) && (unicode <= 0x0CFF)))
			{
				answer += "";
			}
			else
...
function punToGuj(text)
{
	...
	for(var i = 0; i < text.length; i++)
	{
		...
		else
		{
			...
			if((unicode == 0x0A59))
			{
				answer += String.fromCharCode(0x0A96);
			}
			else if((unicode == 0x0A5A))
			{
				answer += String.fromCharCode(0x0A98);
			}
			...
			{
				answer += String.fromCharCode(0x0AAB) + String.fromCharCode(0x0ABC);
			}
			else if((unicode == 0x0A70))
			{
				answer += String.fromCharCode(0x0A81);
			}
			else if((unicode == 0x0A51) || ((unicode >= 0x0A71) && (unicode <= 0x0A7F)))
			{
				answer += "";
			}
			else
...
function benToGuj(text)
{
	...
	for(var i = 0; i < text.length; i++)
	{
		...
		{
			var unicode = text.charCodeAt(i);
			if((unicode == 0x09DC) || (unicode == 0x09DD))
			{
				answer += String.fromCharCode(0x0AB0);
			}
			...
			else if((unicode == 0x0980) || (unicode == 0x09CE) || (unicode == 0x09C7) || ((unicode >= 0x09F0) && (unicode <= 0x09FF)))
			{
				answer += "";
			}
			else
...
function devToGuj(text)
{
	...
	for(var i = 0; i < text.length; i++)
	{
		...
		else
		{
			...
			if(unicode == 0x0904)
			{
				answer += String.fromCharCode(0x0A85);
			}
			else if(unicode == 0x090E)
			{
				answer += String.fromCharCode(0x0A8F);
			}
			else if(unicode == 0x0911)
			{
				answer += String.fromCharCode(0x0A93);
			}
			...
			else if(unicode == 0x0946)
			{
				answer += String.fromCharCode(0x0AC7);
			}
			else if(unicode == 0x094A)
			{
				answer += String.fromCharCode(0x0ACB);
			}
			else if(unicode == 0x0958)
			{
				answer += String.fromCharCode(0x0A95);
			}
			...
			{
				answer += String.fromCharCode(0x0A97);
			}
			...
			{
				answer += String.fromCharCode(0x0AA1);
			}
			else if(unicode == 0x095D)
			{
				answer += String.fromCharCode(0x0AA2);
			}
...
function intelliSense()
{
	...
	var lArr = ["g","d", "k", "t", "tel", "m",  "b", "o", "p"];
	var vArr = [gcount, dCount, kCount, tCount, telcount, mcount, bcount, ocount, pcount];
