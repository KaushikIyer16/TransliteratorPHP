...
function transliterate(text) // Transliteration function
{
    ...
    else if((from == "T") && (to == "M"))
    {
        ...
        return kanToMal(pronunciation(ToKannada(x)));
    }
    else if((from == "B") && (to == "M"))
    {
    	return benToMal(text);
    }
    else if((from == "G") && (to == "M"))
    {
    	return gujToMal(text);
    }
    else if((from == "P") && (to == "M"))
    {
    	return punToMal(text);
    }
    else if((from == "K") && (to == "M"))
    {
    	return kanToMal(text);
    }
    else if((from == "O") && (to == "M"))
    {
    	return oriToMal(text);
    }
    else if((from == "TEL") && (to == "M"))
    {
    	return telToMal(text);
    }
    else
    {
    	alert("Not supported");
...
function telToMal(text)
{
	...
	for(var i = 0; i < text.length; i++)
	{
		...
		else
		{
			...
			if((unicode == 0x0C00))
			{
				answer += String.fromCharCode(0x0D01);
			}
			else if((unicode == 0x0C58))
			{
				answer += String.fromCharCode(0x0D38);
			}
			else if((unicode == 0x0C59))
			{
				answer += String.fromCharCode(0x0D1C);
			}
			else if((unicode == 0x0C55) || (unicode == 0x0C56) || (unicode >= 0x0C70 && unicode <= 0x0C7F))
			{
				answer += "";
			}
			else
...
function oriToMal(text)
{
	...
	for(var i = 0; i < text.length; i++)
	{
		...
		else
		{
			...
			if((unicode == 0x0B0F))
			{
				answer += String.fromCharCode(0x0D0E);
			}
			else if((unicode == 0x0B13))
			{
				answer += String.fromCharCode(0x0D12);
			}
			else if((unicode == 0x0B5C))
			{
				answer += String.fromCharCode(0x0D31);
			}
			else if((unicode == 0x0B5D))
			{
				answer += String.fromCharCode(0x0D30);
			}
			else if((unicode == 0x0B5F))
			{
				answer += String.fromCharCode(0x0D2F);
			}
			else if((unicode == 0x0B3C) || (unicode == 0x0B56) || (unicode >= 0x0B70 && unicode <= 0x0B7F))
			{
				answer += "";
			}
			else
...
function kanToMal(text)
{
	...
	for(var i = 0; i < text.length; i++)
	{
		...
		{
			var unicode = text.charCodeAt(i);
			if((unicode == 0x0CBC) || (unicode == 0x0CD5) || (unicode == 0x0CD6) || (unicode == 0x0CDE) || (unicode >= 0x0CF0 && unicode <= 0x0CFF))
			{
				answer += "";
			}
			else
...
function punToMal(text)
{
	...
	for(var i = 0; i < text.length; i++)
	{
		...
		else
		{
			...
			if((unicode == 0x0A59))
			{
				answer += String.fromCharCode(0x0D16);
			}
			else if((unicode == 0x0A5A))
			{
				answer += String.fromCharCode(0x0D18);
			}
			...
			{
				answer += String.fromCharCode(0x0D2B);
			}
			else if((unicode == 0x0A70))
			{
				answer += String.fromCharCode(0x0D02);
			}
			else if((unicode == 0x0A3C) || (unicode == 0x0A51) || (unicode >= 0x0A71 && unicode <= 0x0A7F))
			{
				answer += "";
			}
			else
...
function benToMal(text)
{
	...
	for(var i = 0; i < text.length; i++)
	{
		...
		else
		{
			...
			{
				answer += String.fromCharCode(0x0D24);
			}
			...
			else if((unicode == 0x0980) || (unicode == 0x09BC) || (unicode >= 0x09F0 && unicode <= 0x09FF))
			{
				answer += "";
			}
			else
...
function gujToMal(text)
{
	...
	for(var i = 0; i < text.length; i++)
	{
		...
		{
			var unicode = text.charCodeAt(i);
			if((unicode == 0x0A8D) || (unicode == 0x0A8F))
			{
				answer += String.fromCharCode(0x0D0E);
			}
			...
			{
				answer += String.fromCharCode(0x0D46);
			}
			else if((unicode == 0x0AC9))
			{
				answer += String.fromCharCode(0x0D4A);
			}
			else if((unicode == 0x0AD0))
			{
				answer += String.fromCharCode(unicode);
			}
			else if((unicode == 0x0ABC) || (unicode >= 0x0AF0 && unicode <= 0x0AFF))
			{
				answer += "";
			}
			else
...
function devToMal(text)
{
	...
	for(var i = 0; i < text.length; i++)
	{
		...
		else
		{
			...
			if(unicode == 0x0904)
			{
				answer += String.fromCharCode(0x0D05);
			}
			...
			{
				answer += String.fromCharCode(0x0D28);
			}
			...
			{
				answer += String.fromCharCode(0x0D33);
			}
			else if((unicode == 0x0945))
			{
				answer += String.fromCharCode(0x0D46);
			}
			...
			{
				answer += String.fromCharCode(0x0D15);
			}
			...
			{
				answer += String.fromCharCode(0x0D17);
			}
			...
			{
				answer += String.fromCharCode(0x0D21);
			}
			else if((unicode == 0x095D))
			{
				answer += String.fromCharCode(0x0D22);
			}
			...
			else if((unicode == 0x0900) || (unicode == 0x093A) || (unicode == 0x093B) || (unicode == 0x093C) || (unicode == 0x094E) || (unicode == 0x094F) || ((unicode >= 0x0951) && (unicode <= 0x0957)) || (unicode >= 0x0970 && unicode <= 0x097F))
			{
				answer += "";
			}
			else
...
function intelliSense()
{
	...
	var lArr = ["m", "d", "k", "t", "tel", "g", "b", "o", "p"];
	var vArr = [mcount, dCount, kCount, tCount, telcount, gcount, bcount, ocount, pcount];
