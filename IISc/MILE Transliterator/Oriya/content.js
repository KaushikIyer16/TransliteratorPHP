...
function transliterate(text) // Transliteration function
{
    ...
    if((from == "T") && (to == "O"))
    {
        ...
        return kanToOri(pronunciation(ToKannada(x)));
    }
    else if((from == "B") && (to == "O"))
    {
    	return benToOri(text);
    }
    else if((from == "G") && (to == "O"))
    {
    	return gujToOri(text);
    }
    else if((from == "P") && (to == "O"))
    {
    	return punToOri(text);
    }
    else if((from == "K") && (to == "O"))
    {
    	return kanToOri(text);
    }
    else if((from == "M") && (to == "O"))
    {
    	return malToOri(text);
    }
    else if((from == "TEL") && (to == "O"))
    {
    	return telToOri(text);
    }
    else
    {
    	alert("Not supported");
...
function benToOri(text)
{
	...
	for(var i = 0; i < text.length; i++)
	{
		...
		else
		{
			...
			if((unicode == 0x0980) || (unicode == 0x09CE) || ((unicode >= 0x09F0) && (unicode <= 0x09FF)))
			{
				answer += "";
			}
			else
...
function gujToOri(text)
{
	...
	for(var i = 0; i < text.length; i++)
	{
		...
		else
		{
			...
			if((unicode == 0x0A8D))
			{
				answer += String.fromCharCode(0x0B0F);
			}
			else if((unicode == 0x0A91))
			{
				answer += String.fromCharCode(0x0B13);
			}
			else if((unicode == 0x0AC5))
			{
				answer += String.fromCharCode(0x0B47);
			}
			else if((unicode == 0x0AC9))
			{
				answer += String.fromCharCode(0x0B4B);
			}
			else if((unicode == 0x0AD0))
			{
				answer += String.fromCharCode(unicode);
			}
			else if(((unicode >= 0x0AF0) && (unicode <= 0x0AFF)))
			{
				answer += "";
			}
			else
...
function punToOri(text)
{
	...
	for(var i = 0; i < text.length; i++)
	{
		...
		{
			var unicode = text.charCodeAt(i);
			if(((unicode >= 0x0A50) && (unicode <= 0x0A5F)) || ((unicode >= 0x0A70) && (unicode <= 0x0A7F)))
			{
				answer += "";
			}
			else
...
function kanToOri(text)
{
	...
	for(var i = 0; i < text.length; i++)
	{
		...
		else
		{
			...
			{
				answer += String.fromCharCode(0x0B30);
			}
			...
			else if(((unicode >= 0x0CD0) && (unicode <= 0x0CDF)) || ((unicode >= 0x0B70) && (unicode <= 0x0B7F)))
			{
				answer += "";
			}
			else
...
function telToOri(text)
{
	...
	for(var i = 0; i < text.length; i++)
	{
		...
		else
		{
			...
			if((unicode == 0x0C00))
			{
				answer += String.fromCharCode(0x0B01);
			}
			...
			{
				answer += String.fromCharCode(0x0B33);
			}
...
function malToOri(text)
{
	...
	for(var i = 0; i < text.length; i++)
	{
		...
		else
		{
			...
			{
				answer += String.fromCharCode(0x0B28);
			}
...
function devToOri(text)
{
	...
	for(var i = 0; i < text.length; i++)
	{
		...
		else
		{
			...
			if(unicode == 0x0904)
			{
				answer += String.fromCharCode(0x0B05);
			}
			...
			{
				answer += String.fromCharCode(0x0B15);
			}
			else if((unicode == 0x0959))
			{
				answer += String.fromCharCode(0x0B16);
			}
			else if((unicode == 0x095A))
			{
				answer += String.fromCharCode(0x0B17);
			}
			else if((unicode == 0x095B))
			{
				answer += String.fromCharCode(0x0B1C);
			}
			else if((unicode == 0x095C))
			{
				answer += String.fromCharCode(0x0B21);
			}
			else if((unicode == 0x095D))
			{
				answer += String.fromCharCode(0x0B22);
			}
			else if((unicode == 0x095E))
			{
				answer += String.fromCharCode(0x0B2B);
			}
			else if((unicode == 0x095F))
			{
				answer += String.fromCharCode(0x0B2F);
			}
