...
chrome.runtime.onInstalled.addListener(function()
{
	...
	{
		"title" : "Transliterate to Punjabi",
		"contexts": ["page"],
		"id": "P"
	});
});
...
chrome.runtime.onMessage.addListener(function(message, sender, sendResponse) 
{
	if(message == "tamMajority")
	{
		...
		chrome.contextMenus.update("P", {"enabled":true});
		chrome.contextMenus.update("P", {"title":"To Punjabi"});
	}
	...
	else if(message == "punMajority")
	{
		...
		chrome.contextMenus.update("P", {"enabled":false});	
		chrome.contextMenus.update("P", {"title":"Page already in Punjabi"});	
	}
