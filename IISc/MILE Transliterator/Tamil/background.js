...
chrome.runtime.onMessage.addListener(function(message, sender, sendResponse) 
{
	if(message == "tamMajority")
	{
		...
		chrome.contextMenus.update("T", {"enabled":false});
		chrome.contextMenus.update("T", {"title": "Page already in Tamil"});
	}
	else if(message == "devMajority")
	{
		from = "D";
		sendResponse("Devanagari Majority");
		chrome.contextMenus.update("T", {"enabled":true});	
		chrome.contextMenus.update("T", {"title": "To Tamil"});	
	}
