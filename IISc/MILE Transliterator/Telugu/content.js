...
function transliterate(text) // Transliteration function
{
    ...
    else if((from == "T") && (to == "TEL"))
    {
        ...
        return kanToTel(pronunciation(ToKannada(x)));
    }
    else if((from == "B") && (to == "TEL"))
    {
    	return benToTel(text);
    }
    else if((from == "G") && (to == "TEL"))
    {
    	return gujToTel(text);
    }
    else if((from == "P") && (to == "TEL"))
    {
    	return punToTel(text);
    }
    else if((from == "K") && (to == "TEL"))
    {
    	return kanToTel(text);
    }
    else if((from == "M") && (to == "TEL"))
    {
    	return malToTel(text);
    }
    else if((from == "O") && (to == "TEL"))
    {
    	return oriToTel(text);
    }
    else
    {
    	alert("Not supported");
...
function punToTel(text)
{
	...
	for(var i = 0; i < text.length; i++)
	{
		...
		else
		{
			...
			if((unicode == 0x0A59))
			{
				answer += String.fromCharCode(0x0C16);
			}
			else if((unicode == 0x0A5A))
			{
				answer += String.fromCharCode(0x0C18);
			}
			else if((unicode == 0x0A5B))
			{
				answer += String.fromCharCode(0x0C1C);
			}
			else if((unicode == 0x0A5C))
			{
				answer += String.fromCharCode(0x0C31);
			}
			else if((unicode == 0x0A5E))
			{
				answer += String.fromCharCode(0x0C2B);
			}
			else if((unicode == 0x0A3C) || (unicode == 0x0A51) || ((unicode >= 0x0A70) && (unicode <= 0x0A7F)))
			{
				answer += "";
			}
			else
...
function kanToTel(text)
{
	...
	for(var i = 0; i < text.length; i++)
	{
		...
		{
			var unicode = text.charCodeAt(i);
			if((unicode == 0x0CBC) || (unicode == 0x0CDE) || ((unicode >= 0x0CF0) && (unicode <= 0x0CFF)))
			{
				answer += "";
			}
			else
...
function malToTel(text)
{
	...
	for(var i = 0; i < text.length; i++)
	{
		...
		else
		{
			...
			if(unicode == 0x0D29)
			{
				answer += String.fromCharCode(0x0C28);
			}
			else if((unicode == 0x0D3A) || (unicode == 0x0D4E) || (unicode == 0x0D57) || ((unicode >= 0x0D70) && (unicode <= 0x0D7F)))
			{
				answer += "";
			}
			else
...
function oriToTel(text)
{
	...
	for(var i = 0; i < text.length; i++)
	{
		...
		else
		{
			...
			{
				answer += String.fromCharCode(0x0C30);
			}
			else if((unicode == 0x0B5F))
			{
				answer += String.fromCharCode(0x0C2F);
			}
...
function benToTel(text)
{
	...
	for(var i = 0; i < text.length; i++)
	{
		...
		else
		{
			...
			else if((unicode == 0x0980) || (unicode == 0x09BC) || (unicode == 0x09CE) || (unicode == 0x09D7) || ((unicode >= 0x09F0) && (unicode <= 0x09FF)))
			{
				answer += "";
			}
			else
...
function devToTel(text)
{
	...
	for(var i = 0; i < text.length; i++)
	{
		...
		else
		{
			...
			if(unicode == 0x0904)
			{
				answer += String.fromCharCode(0x0C05);
			}
			...
			{
				answer += String.fromCharCode(0x0C15);
			}
			...
			{
				answer += String.fromCharCode(0x0C17);
			}
			else if((unicode == 0x095B))
			{
				answer += String.fromCharCode(0x0C19);
			}
			else if((unicode == 0x095C))
			{
				answer += String.fromCharCode(0x0C21);
			}
			else if((unicode == 0x095D))
			{
				answer += String.fromCharCode(0x0C22);
			}
			...
			else if(((unicode >= 0x093A) && (unicode <= 0x093C)) || (unicode == 0x094E) || (unicode == 0x094F) || ((unicode >= 0x0951) && (unicode <= 0x0957)) || ((unicode >= 0x0970) && (unicode <= 0x097F)))
			{
				answer += "";
			}
			else
...
function intelliSense()
{
	...
	var lArr = ["tel", "d", "k", "t", "m", "g", "b", "o", "p"];
	var vArr = [telcount, dCount, kCount, tCount, mcount, gcount, bcount, ocount, pcount];
